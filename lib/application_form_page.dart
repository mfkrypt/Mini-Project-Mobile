...
class _ApplicationFormPageState extends State<ApplicationFormPage> {
  ...
  Widget build(BuildContext context) {
    final boothTotal = widget.cart.fold(0.0, (sum, item) => sum + item.price);
            ...
            child: ListView(
              children: [
                ...
                TextFormField(
                  ...
                  decoration:
                      const InputDecoration(labelText: 'Company Details'),
                  maxLines: 2,
                ),
                const SizedBox(height: 12),
                TextFormField(
                  ...
                  decoration:
                      const InputDecoration(labelText: 'Exhibit Description'),
                  maxLines: 3,
                ),
                const SizedBox(height: 12),
                Text(
                ...
                SizedBox(
                  ...
                  child: FilledButton(
                    onPressed: () async {
                      ...
                      final boothMaps =
                          await db.fetchBoothsForEvent(widget.event.id ?? 0);
                      for (final booth in widget.cart) {
                        ...
                        await db.updateBoothStatus(boothMap.id!, 'pending');
                      }
                      if (chairs) {
