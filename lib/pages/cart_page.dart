...
class CartPage extends StatelessWidget {
  ...
  bool _hasMixedEvents() {
    ...
    return eventId != null && cart.any((item) => item.eventId != eventId);
  }
            ...
            child: ListView(
              ...
              children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: Text(
                            '${index + 1}. Booth ${cart[index].id} (${cart[index].typeName})',
                            style: const TextStyle(
                              fontSize: 18,
                ...
                SizedBox(
                  height: 52,
                  child: FilledButton(
                    onPressed: cart.isEmpty || eventId == null || mixedEvents
                        ? null
                        : () async {
