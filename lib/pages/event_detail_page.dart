...
class EventDetailPage extends StatelessWidget {
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView(
                    ...
                    children: [
                      ...
                      FloorPlanPreview(
                        imagePath: data?.plan?.imagePath,
                        booths: data?.booths ?? const [],
                      ),
                      Padding(
  ...
  Future<_EventDetailData> _loadDetail(int eventId) async {
    ...
    final booths = await db.fetchBoothsForEvent(eventId);
    return _EventDetailData(plan: plan, types: types, booths: booths);
  }
}
